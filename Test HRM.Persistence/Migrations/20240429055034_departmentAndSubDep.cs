...
{
    /// <inheritdoc />
    public partial class departmentAndSubDep : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedOn = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubDepartmentCode = table.Column<int>(type: "int", nullable: false),
                    SubDepartmentName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DepartmemntId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
